                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-lg-6 d-flex align-items-center gradient-custom-2">
                                <div class="text-white px-3 py-4 p-md-5 mx-md-4">
                                    ...
                                    <p class="small mb-0">Aplikasi ini dibuat untuk memenuhi syarat Uji Kompetensi Jurusan PPLG 2023. Aplikasi ini memiliki 3 Role user yaitu Administrator, Petugas, & Siswa.</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row g-0">
                <div class="col-lg-6">
                    <div class="card-body p-md-3 mx-md-4">
                        ...
                        <div class="text-center">
                            <img src="{{ asset('assets/img/logo.png') }}" style="width: 100px;" alt="logo">
                            <h4 class="mt-1 mb-5 pb-1" style="font-size: 25px;">Aplikasi Pembayaran SPP</h4>
                        </div>
                ...
                <div class="col-lg-6 d-flex align-items-center gradient-custom-2">
                    <div class="text-white px-3 py-4 p-md-5 mx-md-4">
                        <h4 class="mb-4">Aplikasi Pembayaran SPP</h4>
                        <p class="small mb-0">Aplikasi ini dibuat untuk memenuhi syarat Uji Kompetensi Jurusan
